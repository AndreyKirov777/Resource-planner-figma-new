...
context:
  ...
  - '{project-root}/_bmad-output/implementation-artifacts/spec-wbs-*.md'
  - '{project-root}/_bmad-output/implementation-artifacts/deferred-work.md'
  - '{project-root}/_bmad-output/test-artifacts/traceability-matrix.md'
out_of_scope:
...
**Problem.** The umbrella product contract (`_bmad-output/specs/spec-resource-planner/SPEC.md`) still describes a 10-capability staffing-plan + planned-AI product. The as-built app is a three-layer planner — **WHAT** (WBS), **WHEN** (Roadmap), **WHO** (Resource Plan) — with AI draft generation shipped and JSON export at `schemaVersion: 4`. Agents that treat the umbrella SPEC as the map will miss two shipped capabilities, treat AI as unbuilt, and treat export v3 as current.
...
**Discovery.** Traceability 2026-08-27 (`_bmad-output/test-artifacts/traceability-matrix.md`) recorded this as **known spec drift**, not a missing feature, and pointed here. The 2026-08-12 WBS proposal already asked to add CAP-11 to the umbrella SPEC; that amend never landed even though WBS shipped.
...
| Roadmap contract exists; umbrella has no CAP-12 | `_bmad-output/specs/spec-roadmap/SPEC.md`; `spec-wbs-schedule` already SUPERSEDED 2026-08-21 |
...
|---|---|---|
| `_bmad-output/specs/spec-resource-planner/SPEC.md` | Stale as a **map**: missing CAP-11/12, wrong AI status, wrong schemaVersion, Why/Success still WHO-only | **Amend** (selected path) |
| `_bmad-output/specs/spec-resource-planner/.memlog.md` | Last updated 2026-08-12; still records AI as unbuilt | **Amend** (log the map update) |
| `_bmad-output/specs/spec-roadmap/SPEC.md` | Already the Roadmap contract; CAP-13 already frozen | **No rewrite.** Umbrella points at it. |
| `_bmad-output/specs/spec-wbs-schedule/` | Already SUPERSEDED 2026-08-21 | **Archive in place** — one-line archive banner; do not move (breaks `spec-roadmap` `supersedes:`); do not revive |
| `_bmad-output/implementation-artifacts/spec-wbs-*.md` | Delivery log of shipped WBS | **Do not rewrite** |
| `_bmad-output/planning-artifacts/sprint-change-proposal-2026-08-12.md` | Historical WBS contract + the CAP-11 amend that never landed | **Do not rewrite.** CAP-11 points at it. |
...
| `_bmad-output/project-context.md` | Binding 50-rule catalog | **Keep** as companion. No change. |
...
**File:** `_bmad-output/specs/spec-resource-planner/SPEC.md`  
...
**File:** `_bmad-output/specs/spec-resource-planner/.memlog.md`
...
**File:** `_bmad-output/specs/spec-wbs-schedule/SPEC.md`  
