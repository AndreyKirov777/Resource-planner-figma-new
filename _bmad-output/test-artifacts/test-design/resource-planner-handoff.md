...
| -------- | ---- | ---------------------- |
| Architecture test design | `_bmad-output/test-artifacts/test-design-architecture.md` | ASRs, high-risk mitigations, NFR unknowns |
| QA test design | `_bmad-output/test-artifacts/test-design-qa.md` | Story AC, test IDs, execution |
...
| SPEC (FR/NFR) | `_bmad-output/specs/spec-resource-planner/SPEC.md` | Capabilities CAP-1–CAP-10 |
| WBS change | `_bmad-output/planning-artifacts/sprint-change-proposal-2026-08-12.md` | CAP-11 |
