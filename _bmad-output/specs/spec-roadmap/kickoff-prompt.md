...
`_bmad-output/specs/spec-roadmap/` is canonical. Read all five before writing code:
`SPEC.md`, then `data-model.md`, `timeline-component.md`, `ux-reference.md`, `delivery.md`.
Then `_bmad-output/project-context.md` for this repo's conventions.

Do **not** implement from `_bmad-output/specs/spec-wbs-schedule/` or from
