...
> Recorded after the frozen intent was approved, per its "renegotiate" clause. Owner: Andrey, 2026-06-30. Source: UX proration in `_bmad-output/planning-artifacts/ux-designs/ux-resource-planner-2026-06-30/` (`DESIGN.md` + `EXPERIENCE.md`). These supersede the matching wording in the frozen section.
...
- `_bmad-output/planning-artifacts/ux-designs/ux-resource-planner-2026-06-30/EXPERIENCE.md` — behavioral spec, all state transitions, allocation timeline detail, copy
- `_bmad-output/planning-artifacts/ux-designs/ux-resource-planner-2026-06-30/DESIGN.md` — visual tokens, `alloc-timeline` component
