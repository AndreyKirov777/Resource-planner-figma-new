...
- After implementation, delete `_bmad-output/planning-artifacts/planning-table-column-visibility-plan.md`.
...
- [x] `_bmad-output/planning-artifacts/planning-table-column-visibility-plan.md` -- Delete after the feature is implemented and verified -- user-requested cleanup
