  ...
  try {
    ...
    const project = await prisma.project.create({
      data: {
        ...
        investment: parsed.data.investment ?? APP_DEFAULTS.investment,
  ...
  try {
    ...
    const copy = await prisma.project.create({
      data: {
        ...
        investment: project.investment ?? APP_DEFAULTS.investment,
  ...
  try {
    ...
    const createdProject = await prisma.project.create({
      data: {
        ...
        investment: projectData.investment ?? APP_DEFAULTS.investment,
