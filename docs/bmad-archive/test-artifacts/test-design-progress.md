...
inputDocuments:
  ...
  - 'docs/bmad-archive/project-context.md'
  ...
  - 'docs/bmad-archive/planning-artifacts/sprint-change-proposal-2026-08-12.md'
  - 'docs/bmad-archive/implementation-artifacts/deferred-work.md'
  - 'docs/bmad-archive/implementation-artifacts/spec-isolate-test-database.md'
  - 'package.json'
...
|----------|--------|--------|
| Functional + NFR-style requirements | `docs/bmad-archive/specs/spec-resource-planner/SPEC.md` (CAP-1–CAP-10, Constraints) | Present |
...
| ADR / architecture decisions | SPEC Constraints; `docs/architecture-review.md`; `docs/bmad-archive/planning-artifacts/sprint-change-proposal-2026-08-12.md` | Present (decision records, not a formal ADR set) |
| Project conventions | `docs/bmad-archive/project-context.md` | Present |

### Related epic/story artifacts (not in scope unless mode changes)

WBS implementation specs under `docs/bmad-archive/implementation-artifacts/` (`spec-wbs-*`) plus UX design docs. These can seed a later Epic-Level run if Andrey wants a WBS-only plan.
...
| risk_threshold | p1 |
| test_artifacts | `docs/bmad-archive/test-artifacts` |
| test_design_output | `docs/bmad-archive/test-artifacts/test-design` |
...
| Document | Path |
| -------- | ---- |
| Architecture | `docs/bmad-archive/test-artifacts/test-design-architecture.md` |
| QA recipe | `docs/bmad-archive/test-artifacts/test-design-qa.md` |
| BMAD handoff | `docs/bmad-archive/test-artifacts/test-design/resource-planner-handoff.md` |
...
- CLI: no orphaned browsers; artifacts only under `docs/bmad-archive/test-artifacts/`
