...
oracleSources:
  ...
  - docs/bmad-archive/specs/spec-roadmap/SPEC.md
...
- UX: `docs/bmad-archive/planning-artifacts/ux-designs/ux-resource-planner-2026-06-30/` (AI generation only)
...
- `docs/architecture.md`, `docs/api-contracts.md`, `docs/bmad-archive/project-context.md`
...
| Live | `docs/bmad-archive/test-artifacts/live-verification-results.json` **absent** | 0 |

```json
{
  "present": false,
  "results_file": "docs/bmad-archive/test-artifacts/live-verification-results.json",
  "source_sha": "",
  "observed_at": "",
  "producer": "",
  "read_error": "",
...
- Product SPEC: `docs/bmad-archive/specs/spec-resource-planner/SPEC.md`
- Roadmap SPEC: `docs/bmad-archive/specs/spec-roadmap/SPEC.md`
- WBS change: `docs/bmad-archive/planning-artifacts/sprint-change-proposal-2026-08-12.md`
- Deferred: `docs/bmad-archive/implementation-artifacts/deferred-work.md`
- TEA design (stale for roadmap): `docs/bmad-archive/test-artifacts/test-design-qa.md`
- Machine summary: `docs/bmad-archive/test-artifacts/e2e-trace-summary.json`
- Gate signal: `docs/bmad-archive/test-artifacts/gate-decision.json`
