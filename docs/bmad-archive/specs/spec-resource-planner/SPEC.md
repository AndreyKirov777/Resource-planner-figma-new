...
- **The full convention catalog is binding.** The 50 rules in `docs/bmad-archive/project-context.md` (companion) govern all implementation; where `README.md` and the code disagree, the code wins.
