...
| Finding | Evidence |
|---|---|
| WBS is entirely greenfield | `grep -rniE "\bwbs\b\|work breakdown"` across code + docs + `docs/bmad-archive` returns **zero** matches |
...
| `docs/bmad-archive/implementation-artifacts/deferred-work.md` | Goal 3 snapshot scope must include WBS | Amend |
