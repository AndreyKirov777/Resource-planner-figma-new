...
- `docs/bmad-archive/specs/spec-resource-planner/SPEC.md` -- CAP-9 success: JSON round-trip includes WBS
...
- [x] `docs/bmad-archive/specs/spec-resource-planner/SPEC.md` -- CAP-9 success mentions WBS in the JSON round-trip
